...
import com.example.indiannaveymr.databinding.ActivityGeneralIntelligenceandReasoningBinding;
...
public class GeneralIntelligenceandReasoningActivity extends AppCompatActivity {

    ActivityGeneralIntelligenceandReasoningBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGeneralIntelligenceandReasoningBinding.inflate(getLayoutInflater());
