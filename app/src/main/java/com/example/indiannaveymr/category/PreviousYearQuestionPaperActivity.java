...
import com.example.indiannaveymr.databinding.ActivityPreviousYearQuestionPaperBinding;
...
public class PreviousYearQuestionPaperActivity extends AppCompatActivity {

    ActivityPreviousYearQuestionPaperBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPreviousYearQuestionPaperBinding.inflate(getLayoutInflater());
