...
import com.example.indiannaveymr.databinding.ActivityReasoningBinding;
...
public class ReasoningActivity extends AppCompatActivity {
    ...
    ActivityReasoningBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityReasoningBinding.inflate(getLayoutInflater());
