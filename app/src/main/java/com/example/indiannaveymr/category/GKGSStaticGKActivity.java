...
import com.example.indiannaveymr.databinding.ActivityGkgsstaticGkactivityBinding;
...
public class GKGSStaticGKActivity extends AppCompatActivity {

    ArrayList<SubjectModel> list;
    SubjectAdapter adapter;


    ActivityGkgsstaticGkactivityBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityGkgsstaticGkactivityBinding.inflate(getLayoutInflater());
